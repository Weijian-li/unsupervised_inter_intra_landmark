...
class Options():
    ...
    def initialize(self):
        self._parser.add_argument('--resume_folder', default='', type=str, metavar='PATH', help='folder')
        self._parser.add_argument('--resume_epoch', default='', type=str, metavar='PATH', help='epoch')
        ...
        self._parser.add_argument('--bSize', default=32, help='Batch Size')
        ...
        self._parser.add_argument('--model', default='ori', type=str, help='model type')
